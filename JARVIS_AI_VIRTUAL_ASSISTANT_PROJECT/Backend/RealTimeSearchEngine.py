...
from dotenv import dotenv_values  # Importing dotenv_values to read environment variables frorm a.env file.
...
# Predefined chatbot conversation system message and an initial user messege.
SystemChatBot = [
...
# Function to get real-time information like the currant date and time.
def Information():
    data = ""
