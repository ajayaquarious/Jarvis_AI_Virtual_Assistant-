...
# Retrieve specific environment variables for username, assitant name, and API key.
...
# Initialize an empty list to store chat meassges.
messages = []
...
def ChatBot(Query):
    ...
    try:
        ...
        # Handle errors by printing the exception and resetting that chat log.
        print(f"Error: {e}")
        with open(r"Data\ChaLog.json", "w") as f:
            dump([], f, indent=4)
